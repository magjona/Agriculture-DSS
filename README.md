...
A Django-based agricultural recommendation system for Ugandan farmers, powered by local agricultural knowledge and data.
...
- **Crop Recommendations** — Tailored to your soil, water source, and location
- **Livestock Recommendations** — Chickens, goats, pigs, cattle, and beekeeping
- **Local Weather Defaults** — Per Ugandan region weather data
...
- **Location-based Filtering** — Group data by Ugandan region
...
Open a fresh Command Prompt or PowerShell in your project directory:
